...
local service = 4599;--Set your Platoboost Id 
local secret = "32cb930f-f6cb-45ea-ad13-aefd18307edc"; --Set Your Platoboost Api key
local useNonce = true; 
...
task.spawn(function()
    ...
    Checkkey.MouseButton1Down:Connect(function() 
        if TextBox and TextBox.Text then
            ...
            if Verify then
                loadstring(game:HttpGet("https://raw.githubusercontent.com/LumeCraftors01/unknown-hub/refs/heads/main/Loaderv1.lua"))()
            else
